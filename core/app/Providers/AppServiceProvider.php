<?php
    ...
    class AppServiceProvider extends ServiceProvider {
        ...
        public function boot() {
            ...
            if ( ! Blueprint::hasMacro( 'imgSeo' ) ) {
                Blueprint::macro( 'imgSeo', function() {
                    $this->string( 'title_tag' )
                         ->unique()
                         ->nullable()
                         ->comment( 'shows as title html attribute in img tag' );
                    $this->string( 'alt_text' )->unique()->nullable()->comment( 'alt text of the image' );
                } );
            }
            ...
            if ( ! Route::hasMacro( 'batch' ) ) {
                Route::macro( 'batch', function( string $name, string $controller ) {
                    Route::patch( Str::lower( $name ), [ $controller, 'batchUpdate' ] );
                } );
            }
